...
public:
	bool initial(HyperParams& opts, AlignedMemoryPool* mem){
		...
		sep_hidden.initial(opts.sep_hidden_dim, opts.char_lstm_dim, opts.char_lstm_dim, opts.word_lstm_dim, true, mem);
		app_hidden.initial(opts.app_hidden_dim, opts.char_lstm_dim, opts.char_lstm_dim, true, mem);
