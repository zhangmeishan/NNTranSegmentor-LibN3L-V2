...
public:
	bool initial(HyperParams& opts){
		...
		//neural features
		char_tanh_conv.initial(opts.char_hidden_dim, opts.char_window_dim);
		...
		word_conv.initial(opts.word_hidden_dim, opts.word_dim, opts.word_dim);
		word_lstm.initial(opts.word_lstm_dim, opts.word_hidden_dim);
		action_conv.initial(opts.action_hidden_dim, opts.action_dim, opts.action_dim);
		action_lstm.initial(opts.action_lstm_dim, opts.action_hidden_dim);
		sep_hidden.initial(opts.sep_hidden_dim, opts.char_lstm_dim, opts.char_lstm_dim, opts.word_lstm_dim, opts.action_lstm_dim);
		app_hidden.initial(opts.app_hidden_dim, opts.char_lstm_dim, opts.char_lstm_dim, opts.action_lstm_dim);
